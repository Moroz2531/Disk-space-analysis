...
void help_draw() {
    ...
    mvprintw(6, 6, "-m\tАнализ использования места на диске из начального каталога");
    mvprintw(7, 6, "-a [dir_path]\tАнализ использования места на диске, включая скрытые объекты");
